...
#####DelhiTotalswDiscom is a dataframe that has been appended with discom values of "total." Now it's time to merge the aggregated data with the original source data. The final dataframe should have 342720+68544=411264 obs. Merge did not work. Will use Rbind, but will need to remove column "X" from source in order to do so.
...
#####First, I set out to gather Delhi Peak, Low, and Average Energy usage spanning the entire 2011-2013 observation period.
