...
opar <- par(no.readonly=TRUE)
par(font=4)
pie3D(d$Death, labels=d$Name, explode=0.1, labelcex=0.7, start=0, col=c("red","blue","brown","green","orange","yellow","pink","purple"), main="Death Pie Chart")
pie3D(d$MoneyRaised, labels=d$Name, explode=0.1, labelcex=0.8, start=0, col=c("red","blue","brown","green","orange","yellow","pink","purple"), main="Donation pie chart")
par(opar)
```
