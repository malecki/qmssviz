...
names(DelhiData) <- c("discom", "timeslots", "days", "date", "mW", "timepoint", "Average mW")
Delhi2010 <- merge(Peaks2010, Averages2010, by=c("discom"))
names(Delhi2010) <- c("discom", "timeslots", "days", "date", "mW", "timepoint", "Average mW")
Delhi2011 <- merge(Peaks2011, Averages2011, by=c("discom"))
names(Delhi2011) <- c("discom", "timeslots", "days", "date", "mW", "timepoint", "Average mW")
Delhi2012 <- merge(Peaks2012, Averages2012, by=c("discom"))
names(Delhi2012) <- c("discom", "timeslots", "days", "date", "mW", "timepoint", "Average mW")
Delhi2013 <- merge(Peaks2013, Averages2013, by=c("discom"))
names(Delhi2013) <- c("discom", "timeslots", "days", "date", "mW", "timepoint", "Average mW")
```
