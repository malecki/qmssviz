...
country_list = vector(country_list,na.rm=TRUE)
...
country_matrix5 = matrix(nrow=18,ncol=3)
country_matrix5[,1]=country_matrix4[,1]
country_matrix5[,2]=country_matrix3[,2]
country_matrix5[,3]=country_matrix3[,3]
country_matrix5
...
```{r}
ggplot(country_matrix3, aes(x=Country,y=WV4_percent)) 
