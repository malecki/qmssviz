...
ggplot(TotalPeakData, aes(y=mW ,x=discom, fill=discom)) + geom_bar(stat="identity", width=.75, alpha = 3/4) + ggtitle(TotalPeakTitleText) + ylab("mW by Distribution Company") + xlab("") + geom_text(aes(label = mW, y=mW+125, size=4)) + theme(legend.position="none")
```
