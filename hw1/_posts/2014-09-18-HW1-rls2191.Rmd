...
health_gps$xcoord <- as.scalar(health_gps$xcoord)
health_gps$ycoord <- as.salar(health_gps$ycoord)
health_gps$gps_unsure1 <- as.scalar(health_gps$gps_unsure1)
health_gps$xgps_unsure2 <- as.scalar(health_gps$gps_unsure2)
