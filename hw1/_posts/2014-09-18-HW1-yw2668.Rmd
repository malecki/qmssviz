...
<hr/>
--
Improve my last assignment

First of all, I'd like to resolve the remaining questions:
1.
2.
```{r}

ggplot(r,aes(x=soft.r.level, fill=Program))+geom_bar(width=0.8, position="dodge", colour="black")+xlab("Levels in R, Data Manipulation & Modeling") + 
    ylab("Count") + 
    ggtitle("Different Levels in R of Different Programs")+scale_fill_brewer(palette="Pastel1")
