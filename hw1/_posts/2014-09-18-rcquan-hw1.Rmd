...
## Total Meetings Held by Committee by Month
...
This graph allows the user to compare the number of committee meetings held by each committee for each month. However, the use of total number should be viewed with skepticism.
