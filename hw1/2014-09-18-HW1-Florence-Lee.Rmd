...
### Another view: Boxplot

On a second pass, it seems more sensible, visually, to look at the distribution of BMI and eating restaurant-prepared food within each occupational group through a boxplot. With a boxplot, I will only be able to look at one variable of interest at a time, but that might present more interesting information. 
