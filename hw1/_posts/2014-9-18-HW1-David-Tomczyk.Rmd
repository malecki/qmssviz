...
-I was able to manipulate the dataset in r to get counts, condense similar categories, change axis/title
...
```{r ggplot2, fig.width=14, fig.height=5, message=FALSE}
...
ggplot(progtwit, aes(Program, fill=Do.you.use.twitter.)) + geom_bar()
...
``` {r ggplot3, fig.width=3, fig.height=7, message=FALSE}
...
``` {r ggplot4, fig.width=3, fig.height=3, message=FALSE}
