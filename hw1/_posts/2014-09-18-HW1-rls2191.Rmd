...
```
Here is a scatter plot of doctors vs. nurses. The dot colors refer to the region of the clinic. It becomes clear that the grions are clustered but not systematically separated in any obvious way. Previously dropped points are still present on this plot.
```{r}
library(ggplot2)
