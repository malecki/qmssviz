...
## Summary:
From the graph, we can see that in some countries, there are more people feeling very happy(such as Mexico, Nigeria and South Korea), while in some countries there's a decrease. We can get similar conclusions such as differences in two waves in different countries from the gragh. 
...
{
data <- subset(data,select=c("v1","v18","v2"),v2==156|v2==392|v2==410|v2==484|v2==566|v2==724)
}

## combinedata <- funciton(data1, data2)
{
rbind(data1, data2)
}
...
{
colnames(data) <- c("year","happiness","country")
}
