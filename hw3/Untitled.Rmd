...
If one really thought that incomes should be made more equal, and gave a score of 1 or 2, it probably demonstrated that the income inequality at that time was really severe, vice versa. Thus, we could find out the changes of the social equality from the answers of respondents.
...
```
2. 
```{r,fig.height=9,fig.width=14.562}
library(ggplot2)
