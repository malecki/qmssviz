...
program2.df <-as.data.frame.table(table(factor(responses[[2]])),stringsAsFactors=FALSE)
...
ggplot(data=program2.df, aes(x=Program, y=Freq, fill=Program), main="Class Make Up") + geom_bar(stat="identity")+guides(fill=FALSE)
