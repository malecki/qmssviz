...
### Introduction
This article use 'National Annenberg Election Survey 2008' from The Annenberg Public Policy Center. This survey is a public opinion survey conducted via the Internet and designed to track the dynamics of political attitudes, perceptions, and behavior over the 2008 US primary and general presidential election campaigns. To be noted, The whole interview was segmented into five multi-month waves, numbered 1 – 5 and corresponding to the major divisions of the campaign: pre-primary, primary election, spring and summer, general election, and post-election. 
